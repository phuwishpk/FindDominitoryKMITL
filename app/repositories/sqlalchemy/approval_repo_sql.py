...
class SqlPropertyRepo:
    ...
    def get(self, prop_id: int):
        from app.models.property import Property # FIX: นำเข้าภายในเมธอด
    ...
    def list_approved(self, **filters):
        from app.models.property import Property, Amenity, PropertyAmenity # FIX: นำเข้าภายในเมธอด
    ...
    def list_all_paginated(self, search_query=None, page=1, per_page=15):
        from app.models.property import Property # FIX
        from app.models.user import Owner # FIX
